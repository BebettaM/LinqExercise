...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //TODO: Print all the employees' FullName properties to the console only if their FirstName starts with a C OR an S and order
            //this in ascending order by FirstName.
            var filter =
